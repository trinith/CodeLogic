...
// $TEMPLATE_NAMESPACE
namespace BriefingBuilder.Template
{
    // $TEMPLATE_CLASS_NAME
    public class TEMPLATE_ContentPageTemplate : LayerBase
    {
        ...
        // $TEMPLATE_CLASS_NAME
        public TEMPLATE_ContentPageTemplate(IEngine host, ISpriteBatch mainSpriteBatch, RectangleF contentBounds, ITextObjectBuilder textBuilder, ITextObjectRendererFactory rendererFactory, IUIObjectFactory uiObjectFactory)
